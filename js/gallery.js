const images = [
            ...
            function updateGallery() {
                ...
                document.querySelectorAll(".gallery-pagination .page-item").forEach(el => el.classList.remove("active"));
                document.querySelectorAll(".gallery-pagination .page-item")[currentIndex - 1].classList.add("active");
            }
